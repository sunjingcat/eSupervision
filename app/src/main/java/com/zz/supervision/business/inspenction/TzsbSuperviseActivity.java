...
//import com.zz.supervision.business.inspenction.adapter.TzsbSuperviseAdapter;
...
// * 监督检查:特种设备
// */
//public class TzsbSuperviseActivity extends MyBaseActivity<Contract.IsetSupervisePresenter> implements Contract.IGetSuperviseView {
...
//        adapter = new TzsbSuperviseAdapter(new OnProviderOnClick() {
//            @Override
//            public void onItemOnclick(BaseNode node, int type) {
//                if (node instanceof SuperviseBean || (node instanceof SuperviseBean.Children && ((SuperviseBean.Children) node).getChildType() == 1)) {
//                    if (type == 10) {
